...
setup(
    ...
    description="Manage personal programs and configs for bootstrapping and maintaining productive work environments in linux.",
    #long_description=open('README.org').read(),
    license="MIT",
    url="https://github.com/salotz/bimker",
    classifiers=[
        "Topic :: Utilities",
